...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/workspace/devel/include;/workspace/src/franka_ros/franka_example_controllers/include;/usr/include".split(';') if "/workspace/devel/include;/workspace/src/franka_ros/franka_example_controllers/include;/usr/include" != "" else []
