...
def move_to_small_cartesian_position(
    arm:PandaArm,
    ...
    WARNING: The position to move to must be VERY close to the current position
    ...
    arm.exec_position_cmd(ik_joint_solutions)
